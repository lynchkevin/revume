  ...
  .controller('resetPasswordCtrl', ['$scope', '$rootScope', 'userService', '$timeout','$ionicPopup',
   function ($scope,$rootScope,userService,$timeout,$ionicPopup) {
       $scope.resetPassword = function(){
           ...
           credentials.oldPassword = atob($scope.forms.resetPw.oldPassword);
           credentials.password = atob($scope.forms.resetPw.newPassword);
           credentials.repeat = atob($scope.forms.resetPw.repeat);
